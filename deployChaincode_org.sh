...
#        -c '{"function": "CreateOrg","Args":["{\"id\":\"1\",\"make\":\"Audi\",\"addedAt\":1600138309939,\"model\":\"R8\", \"color\":\"red\",\"owner\":\"pavan\"}"]}'
...
chaincodeQuery() {
    setGlobalsForPeer0Broker
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "GetOrgById","Args":["broker"]}'
}
