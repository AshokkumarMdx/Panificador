...
presetup() {
    ...
    pushd ./artifacts/src/github.com/user
...
CC_SRC_PATH="./artifacts/src/github.com/user/go"
CC_NAME="user"
...
chaincodeInvoke() {
	...
	--tls $CORE_PEER_TLS_ENABLED \
        ...
        --peerAddresses localhost:13051 --tlsRootCertFiles $PEER0_MILLS_CA   \
        --peerAddresses localhost:15051 --tlsRootCertFiles $PEER0_BAKER_CA   \
        -c '{"function":"createUser","Args":["{\"userId\":\"user2\",\"userName\":\"tarun\",\"password\":\"1234\",\"orgId\":\"farmer\",\"orgName\":\"Microsoft\",\"email\":\"1234\",\"phone\":\"888888888\",\"status\":\"Active\",\"role\":\"Farmer\"}"]}'
#        -c '{"function": "createUser","Args":["{\"id\":\"1\",\"make\":\"Audi\",\"addedAt\":1600138309939,\"model\":\"R8\", \"color\":\"red\",\"owner\":\"pavan\"}"]}'
...
chaincodeQuery() {
    setGlobalsForPeer0Broker
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "queryUserByID","Args":["user2"]}'
}
